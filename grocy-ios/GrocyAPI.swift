...
//    func getObjectWithSearch<T: Codable>(object: ObjectEntities, id: String, searchString: String) -> AnyPublisher<T, APIError>
}
...
extension GrocyApi {
    ...
    func putObjectWithID<T: Codable>(object: ObjectEntities, id: String, content: Data) -> AnyPublisher<T, APIError> {
        return call(.objectsEntityWithID, method: .PUT, object: object, id: id)
    }
...
//    func getObjectWithSearch<T: Codable>(object: ObjectEntities, id: String, searchString: String) -> AnyPublisher<T, APIError> {
//        // noch TODO
//        return call(.objects, method: .GET, object: object, id: id)
//    }
}
